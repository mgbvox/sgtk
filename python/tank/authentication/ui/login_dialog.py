...
class Ui_LoginDialog(object):
    def setupUi(self, LoginDialog):
        ...
        self.logo.setText("")
        self.logo.setPixmap(
            QtGui.QPixmap(":/shotgun_authentication/shotgun_logo_light_medium.png")
        )
        ...
        self.label.setPixmap(
            QtGui.QPixmap(":/google_authenticator/google_authenticator.png")
        )
        ...
        self._2fa_message.setAlignment(
            QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter
        )
        ...
        self.label_2.setPixmap(
            QtGui.QPixmap(":/backup_codes/backup_codes_light_bg.png")
        )
    ...
    def retranslateUi(self, LoginDialog):
        LoginDialog.setWindowTitle(
            QtGui.QApplication.translate(
                "LoginDialog",
                "Flow Production Tracking Login",
                None,
        ...
        self.site.setAccessibleName(
            QtGui.QApplication.translate(
                "LoginDialog", "site", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.login.setAccessibleName(
            QtGui.QApplication.translate(
                "LoginDialog", "login", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.password.setAccessibleName(
            QtGui.QApplication.translate(
                "LoginDialog", "password", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        ...
        self.button_options.setText(
            QtGui.QApplication.translate(
                "LoginDialog", "See other options", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        ...
        self.sign_in.setText(
            QtGui.QApplication.translate(
                "LoginDialog", "Sign In", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.sign_in.setProperty(
            "class",
            QtGui.QApplication.translate(
                "LoginDialog", "main", None, QtGui.QApplication.UnicodeUTF8
            ),
        )
        ...
        self._2fa_code.setAccessibleName(
            QtGui.QApplication.translate(
                "LoginDialog", "2fa code", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self._2fa_code.setPlaceholderText(
            QtGui.QApplication.translate(
                "LoginDialog", "Enter code", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.use_backup.setText(
            QtGui.QApplication.translate(
                "LoginDialog", "Use backup code", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.verify_2fa.setText(
            QtGui.QApplication.translate(
                "LoginDialog", "Verify", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        ...
        self.backup_code.setAccessibleName(
            QtGui.QApplication.translate(
                "LoginDialog", "backup code", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.backup_code.setPlaceholderText(
            QtGui.QApplication.translate(
                "LoginDialog", "Enter backup code", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.use_app.setText(
            QtGui.QApplication.translate(
                "LoginDialog", "Use Google App", None, QtGui.QApplication.UnicodeUTF8
            )
        )
